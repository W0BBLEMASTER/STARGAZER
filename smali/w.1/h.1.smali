...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lw/h;->c:Landroid/view/View;
...
.method private g(IIII[II[I)Z
    ...
    iget-boolean v2, v1, Lw/h;->d:Z

    const/4 v11, 0x0

    if-eqz v2, :cond_a

    invoke-direct {p0, v0}, Lw/h;->h(I)Landroid/view/ViewParent;
    ...
    iget-object v2, v1, Lw/h;->c:Landroid/view/View;
    ...
    :goto_2
    iget-object v3, v1, Lw/h;->c:Landroid/view/View;

    instance-of v2, v8, Lw/j;
    ...
    invoke-interface/range {v2 .. v9}, Lw/j;->onNestedScroll(Landroid/view/View;IIIII[I)V
    ...
    invoke-interface/range {v2 .. v8}, Lw/i;->onNestedScroll(Landroid/view/View;IIIII)V
    ...
    iget-object v0, v1, Lw/h;->c:Landroid/view/View;
...
.method private h(I)Landroid/view/ViewParent;
    ...
    :cond_0
    iget-object p1, p0, Lw/h;->b:Landroid/view/ViewParent;

    return-object p1

    :cond_1
    iget-object p1, p0, Lw/h;->a:Landroid/view/ViewParent;
...
.method public final a(FFZ)Z
    ...
    invoke-direct {p0, v1}, Lw/h;->h(I)Landroid/view/ViewParent;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v2, p0, Lw/h;->c:Landroid/view/View;
...
.method public final c(II[I[II)Z
    ...
    invoke-direct {p0, v7}, Lw/h;->h(I)Landroid/view/ViewParent;
    ...
    invoke-interface/range {v2 .. v7}, Lw/i;->onNestedPreScroll(Landroid/view/View;II[II)V
...
.method public final d(IIII[II[I)V
    ...
    invoke-direct/range {p0 .. p7}, Lw/h;->g(IIII[II[I)Z
...
.method public final e(IIII[I)Z
    ...
    invoke-direct/range {v0 .. v7}, Lw/h;->g(IIII[II[I)Z
...
.method public final i(I)Z
    ...
    invoke-direct {p0, p1}, Lw/h;->h(I)Landroid/view/ViewParent;
...
.method public final k(Z)V
    ...
    iget-object v0, p0, Lw/h;->c:Landroid/view/View;
...
.method public final l(II)Z
    ...
    invoke-virtual {p0, p2}, Lw/h;->i(I)Z
    ...
    iget-object v3, p0, Lw/h;->c:Landroid/view/View;

    :goto_0
    if-eqz v0, :cond_9

    iget-object v4, p0, Lw/h;->c:Landroid/view/View;
    ...
    invoke-interface {v8, v3, v4, p1, p2}, Lw/i;->onStartNestedScroll(Landroid/view/View;Landroid/view/View;II)Z
    ...
    :cond_3
    iput-object v0, p0, Lw/h;->b:Landroid/view/ViewParent;

    goto :goto_2

    :cond_4
    iput-object v0, p0, Lw/h;->a:Landroid/view/ViewParent;
    ...
    invoke-interface {v0, v3, v2, p1, p2}, Lw/i;->onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;II)V
...
.method public final m(I)V
    ...
    iget-object v1, p0, Lw/h;->c:Landroid/view/View;
    ...
    invoke-interface {v0, v1, p1}, Lw/i;->onStopNestedScroll(Landroid/view/View;I)V
