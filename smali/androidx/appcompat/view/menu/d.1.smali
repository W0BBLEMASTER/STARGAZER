...
.field protected c:Landroidx/appcompat/view/menu/r;
...
.field protected h:Landroidx/appcompat/view/menu/H;
...
.method public b(Z)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/r;->k()V

    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->c:Landroidx/appcompat/view/menu/r;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/r;->r()Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v5}, Landroidx/appcompat/view/menu/d;->n(Landroidx/appcompat/view/menu/u;)Z
    ...
    :goto_1
    invoke-virtual {p0, v5, v6, p1}, Landroidx/appcompat/view/menu/d;->l(Landroidx/appcompat/view/menu/u;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_3
    iget-object v5, p0, Landroidx/appcompat/view/menu/d;->h:Landroidx/appcompat/view/menu/H;
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/view/menu/d;->j(Landroid/view/ViewGroup;I)Z
...
.method public f(Landroid/content/Context;Landroidx/appcompat/view/menu/r;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/appcompat/view/menu/d;->c:Landroidx/appcompat/view/menu/r;

    return-void
.end method

.method public g(Landroidx/appcompat/view/menu/O;)Z
    .locals 1
...
.method public abstract i(Landroidx/appcompat/view/menu/u;Landroidx/appcompat/view/menu/G;)V
.end method

.method protected abstract j(Landroid/view/ViewGroup;I)Z
.end method

.method public final k()Landroidx/appcompat/view/menu/E;
    .locals 1
...
.method public l(Landroidx/appcompat/view/menu/u;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 2
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/view/menu/d;->i(Landroidx/appcompat/view/menu/u;Landroidx/appcompat/view/menu/G;)V
...
.method public m(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/H;
    .locals 3
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/view/menu/H;->initialize(Landroidx/appcompat/view/menu/r;)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/d;->b(Z)V
...
.method public abstract n(Landroidx/appcompat/view/menu/u;)Z
.end method
