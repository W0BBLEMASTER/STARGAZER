...
.field private mMenu:Landroidx/appcompat/view/menu/r;

.field mMenuBuilderCallback:Landroidx/appcompat/view/menu/p;
...
.field private mPresenter:Landroidx/appcompat/widget/p;
...
.method static measureChildForCells(Landroid/view/View;IIII)I
    ...
    :goto_2
    iget-boolean p2, v0, Landroidx/appcompat/widget/s;->c:Z
    ...
    :goto_3
    iput-boolean v1, v0, Landroidx/appcompat/widget/s;->f:Z

    iput v3, v0, Landroidx/appcompat/widget/s;->d:I
...
.method private onMeasureExactFormat(II)V
    ...
    iput-boolean v14, v9, Landroidx/appcompat/widget/s;->h:Z

    iput v14, v9, Landroidx/appcompat/widget/s;->e:I

    iput v14, v9, Landroidx/appcompat/widget/s;->d:I

    iput-boolean v14, v9, Landroidx/appcompat/widget/s;->f:Z
    ...
    :goto_2
    iput-boolean v3, v9, Landroidx/appcompat/widget/s;->g:Z

    iget-boolean v3, v9, Landroidx/appcompat/widget/s;->c:Z
    ...
    iget-boolean v14, v9, Landroidx/appcompat/widget/s;->f:Z
    ...
    :cond_5
    iget-boolean v9, v9, Landroidx/appcompat/widget/s;->c:Z
    ...
    iget-boolean v10, v9, Landroidx/appcompat/widget/s;->f:Z
    ...
    :cond_a
    iget v9, v9, Landroidx/appcompat/widget/s;->d:I
    ...
    iget v9, v10, Landroidx/appcompat/widget/s;->d:I
    ...
    iget-boolean v1, v10, Landroidx/appcompat/widget/s;->g:Z
    ...
    :goto_b
    iget v1, v10, Landroidx/appcompat/widget/s;->d:I

    const/4 v2, 0x1

    add-int/2addr v1, v2

    iput v1, v10, Landroidx/appcompat/widget/s;->d:I

    iput-boolean v2, v10, Landroidx/appcompat/widget/s;->h:Z
    ...
    iget-boolean v2, v2, Landroidx/appcompat/widget/s;->g:Z
    ...
    iput v1, v6, Landroidx/appcompat/widget/s;->e:I

    const/4 v3, 0x1

    iput-boolean v3, v6, Landroidx/appcompat/widget/s;->h:Z

    if-nez v2, :cond_1b

    iget-boolean v3, v6, Landroidx/appcompat/widget/s;->g:Z
    ...
    iget-boolean v3, v6, Landroidx/appcompat/widget/s;->c:Z
    ...
    check-cast v3, Landroidx/appcompat/widget/s;

    iget-boolean v6, v3, Landroidx/appcompat/widget/s;->h:Z
    ...
    :cond_22
    iget v6, v3, Landroidx/appcompat/widget/s;->d:I

    mul-int/2addr v6, v8

    iget v3, v3, Landroidx/appcompat/widget/s;->e:I
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    instance-of p1, p1, Landroidx/appcompat/widget/s;
...
.method public dismissPopupMenus()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->mPresenter:Landroidx/appcompat/widget/p;
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroidx/appcompat/widget/g0;
    .locals 1
...
.method protected generateDefaultLayoutParams()Landroidx/appcompat/widget/s;
    .locals 2
    ...
    iput v1, v0, Landroidx/appcompat/widget/g0;->b:I
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g0;
    .locals 0
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/g0;
    .locals 0
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
    ...
    invoke-direct {v0, v1, p1}, Landroidx/appcompat/widget/s;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/s;
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroidx/appcompat/widget/s;-><init>(Landroidx/appcompat/widget/s;)V
    ...
    invoke-direct {v0, p1}, Landroidx/appcompat/widget/s;-><init>(Landroid/view/ViewGroup$LayoutParams;)V

    :goto_0
    iget p1, v0, Landroidx/appcompat/widget/g0;->b:I

    if-gtz p1, :cond_1

    const/16 p1, 0x10

    iput p1, v0, Landroidx/appcompat/widget/g0;->b:I
...
.method public generateOverflowButtonLayoutParams()Landroidx/appcompat/widget/s;
    ...
    iput-boolean v1, v0, Landroidx/appcompat/widget/s;->c:Z
...
.method public getMenu()Landroid/view/Menu;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->mMenu:Landroidx/appcompat/view/menu/r;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->mMenu:Landroidx/appcompat/view/menu/r;

    new-instance v2, Landroidx/appcompat/widget/t;

    invoke-direct {v2, p0}, Landroidx/appcompat/widget/t;-><init>(Landroidx/appcompat/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Landroidx/appcompat/view/menu/r;->C(Landroidx/appcompat/view/menu/p;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->mPresenter:Landroidx/appcompat/widget/p;

    invoke-virtual {v1}, Landroidx/appcompat/widget/p;->C()V
    ...
    :goto_0
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/d;->d(Landroidx/appcompat/view/menu/E;)V

    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->mMenu:Landroidx/appcompat/view/menu/r;

    iget-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->mPresenter:Landroidx/appcompat/widget/p;
    ...
    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/p;->A(Landroidx/appcompat/widget/ActionMenuView;)V
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/p;->u()Landroid/graphics/drawable/Drawable;
...
.method protected hasSupportDividerBeforeChildAt(I)Z
    ...
    instance-of v3, v1, Landroidx/appcompat/widget/q;

    if-eqz v3, :cond_1

    check-cast v1, Landroidx/appcompat/widget/q;

    invoke-interface {v1}, Landroidx/appcompat/widget/q;->needsDividerAfter()Z
    ...
    instance-of p1, v2, Landroidx/appcompat/widget/q;

    if-eqz p1, :cond_2

    check-cast v2, Landroidx/appcompat/widget/q;

    invoke-interface {v2}, Landroidx/appcompat/widget/q;->needsDividerBefore()Z
...
.method public initialize(Landroidx/appcompat/view/menu/r;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->mMenu:Landroidx/appcompat/view/menu/r;

    return-void
.end method

.method public invokeItem(Landroidx/appcompat/view/menu/u;)Z
    .locals 3
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroidx/appcompat/view/menu/r;->y(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/F;I)Z
...
.method public isOverflowMenuShowPending()Z
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/p;->v:Landroidx/appcompat/widget/l;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->mPresenter:Landroidx/appcompat/widget/p;

    if-eqz p1, :cond_0

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/p;->b(Z)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->mPresenter:Landroidx/appcompat/widget/p;

    invoke-virtual {p1}, Landroidx/appcompat/widget/p;->w()Z
    ...
    invoke-virtual {p1}, Landroidx/appcompat/widget/p;->v()Z

    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->mPresenter:Landroidx/appcompat/widget/p;

    invoke-virtual {p1}, Landroidx/appcompat/widget/p;->D()Z
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v11, Landroidx/appcompat/widget/s;

    iget-boolean v14, v11, Landroidx/appcompat/widget/s;->c:Z
    ...
    iget-boolean v8, v6, Landroidx/appcompat/widget/s;->c:Z
...
.method protected onMeasure(II)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->mMenu:Landroidx/appcompat/view/menu/r;
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/view/menu/r;->x(Z)V
...
.method public peekMenu()Landroidx/appcompat/view/menu/r;
    .locals 1
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/p;->z(Z)V
...
.method public setMenuCallbacks(Landroidx/appcompat/view/menu/E;Landroidx/appcompat/view/menu/p;)V
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionMenuView;->mMenuBuilderCallback:Landroidx/appcompat/view/menu/p;
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/p;->B(Landroid/graphics/drawable/Drawable;)V
...
.method public setPresenter(Landroidx/appcompat/widget/p;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->mPresenter:Landroidx/appcompat/widget/p;

    invoke-virtual {p1, p0}, Landroidx/appcompat/widget/p;->A(Landroidx/appcompat/widget/ActionMenuView;)V
