...
.method private c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lq/b;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-direct {p0, v1, p2}, Landroidx/appcompat/widget/K;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-interface {v0, p2}, Lq/b;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v5, v4}, Landroidx/appcompat/widget/K;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method b(Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, v7, v0}, Landroidx/appcompat/widget/K;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2, v2}, Landroidx/appcompat/widget/K;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
