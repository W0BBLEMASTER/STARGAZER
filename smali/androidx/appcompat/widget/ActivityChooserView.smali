...
.field final mAdapter:Landroidx/appcompat/widget/B;

.field private final mCallbacks:Landroidx/appcompat/widget/C;
...
.field private mListPopupWindow:Landroidx/appcompat/widget/n0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroidx/appcompat/widget/w;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V
    ...
    invoke-direct {v0, p0}, Landroidx/appcompat/widget/x;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V
    ...
    sget-object v1, Lb/j;->ActivityChooserView:[I
    ...
    sget p3, Lb/j;->ActivityChooserView_initialActivityCount:I
    ...
    sget p3, Lb/j;->ActivityChooserView_expandActivityOverflowButtonDrawable:I
    ...
    invoke-direct {p2, p0}, Landroidx/appcompat/widget/C;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActivityChooserView;->mCallbacks:Landroidx/appcompat/widget/C;
    ...
    invoke-direct {p2}, Landroidx/appcompat/widget/y;-><init>()V
    ...
    invoke-direct {p2, p0, v0}, Landroidx/appcompat/widget/z;-><init>(Landroidx/appcompat/widget/ActivityChooserView;Landroid/widget/FrameLayout;)V
    ...
    invoke-direct {p2, p0}, Landroidx/appcompat/widget/B;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/B;

    new-instance p3, Landroidx/appcompat/widget/A;

    invoke-direct {p3, p0}, Landroidx/appcompat/widget/A;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V
...
.method public dismissPopup()Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/ActivityChooserView;->getListPopupWindow()Landroidx/appcompat/widget/n0;
...
.method public getDataModel()Landroidx/appcompat/widget/v;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/B;
...
.method getListPopupWindow()Landroidx/appcompat/widget/n0;
    .locals 5

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mListPopupWindow:Landroidx/appcompat/widget/n0;
    ...
    sget v2, Lb/a;->listPopupWindowStyle:I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mListPopupWindow:Landroidx/appcompat/widget/n0;

    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/B;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n0;->h(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mListPopupWindow:Landroidx/appcompat/widget/n0;

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/n0;->i(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mCallbacks:Landroidx/appcompat/widget/C;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n0;->r(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mListPopupWindow:Landroidx/appcompat/widget/n0;

    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mCallbacks:Landroidx/appcompat/widget/C;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n0;->q(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public setActivityChooserModel(Landroidx/appcompat/widget/v;)V
    .locals 1

    iget-object p1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/B;

    iget-object v0, p1, Landroidx/appcompat/widget/B;->a:Landroidx/appcompat/widget/ActivityChooserView;

    iget-object v0, v0, Landroidx/appcompat/widget/ActivityChooserView;->mAdapter:Landroidx/appcompat/widget/B;
...
.method public setProvider(Lw/e;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mProvider:Lw/e;
