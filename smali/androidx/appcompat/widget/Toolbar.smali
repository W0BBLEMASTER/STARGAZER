...
.field private mContentInsets:Landroidx/appcompat/widget/q0;
...
.field private mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;
...
.field private mMenuBuilderCallback:Landroidx/appcompat/view/menu/p;
...
.field mOnMenuItemClickListener:Landroidx/appcompat/widget/a1;

.field private mOuterActionMenuPresenter:Landroidx/appcompat/widget/p;
...
.field private mWrapper:Landroidx/appcompat/widget/e1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p1, p0}, Landroidx/appcompat/widget/V0;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mMenuViewItemClickListener:Landroidx/appcompat/widget/u;

    new-instance p1, Landroidx/appcompat/widget/W0;

    invoke-direct {p1, p0}, Landroidx/appcompat/widget/W0;-><init>(Landroidx/appcompat/widget/Toolbar;)V
    ...
    invoke-static {p1, p2, v0, p3, v1}, Landroidx/appcompat/widget/U0;->t(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/U0;
    ...
    invoke-virtual {p1, p2, p3}, Landroidx/appcompat/widget/U0;->k(II)I
    ...
    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/U0;->d(II)I

    move-result p2

    sget p3, Lb/j;->Toolbar_titleMargins:I

    invoke-virtual {p1, p3}, Landroidx/appcompat/widget/U0;->q(I)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1, p3, p2}, Landroidx/appcompat/widget/U0;->d(II)I
    ...
    invoke-virtual {p1, p2, p3}, Landroidx/appcompat/widget/U0;->d(II)I
    ...
    invoke-virtual {p1, p2, p3}, Landroidx/appcompat/widget/U0;->e(II)I
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/U0;->d(II)I

    move-result p2

    sget v2, Lb/j;->Toolbar_contentInsetEnd:I

    invoke-virtual {p1, v2, v0}, Landroidx/appcompat/widget/U0;->d(II)I

    move-result v2

    sget v3, Lb/j;->Toolbar_contentInsetLeft:I

    invoke-virtual {p1, v3, v1}, Landroidx/appcompat/widget/U0;->e(II)I

    move-result v3

    sget v4, Lb/j;->Toolbar_contentInsetRight:I

    invoke-virtual {p1, v4, v1}, Landroidx/appcompat/widget/U0;->e(II)I

    move-result v4

    invoke-direct {p0}, Landroidx/appcompat/widget/Toolbar;->ensureContentInsets()V

    iget-object v5, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Landroidx/appcompat/widget/q0;

    invoke-virtual {v5, v3, v4}, Landroidx/appcompat/widget/q0;->e(II)V
    ...
    :cond_5
    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Landroidx/appcompat/widget/q0;

    invoke-virtual {v3, p2, v2}, Landroidx/appcompat/widget/q0;->g(II)V
    ...
    invoke-virtual {p1, p2, p3}, Landroidx/appcompat/widget/U0;->b(II)I
...
.method private addCustomViewsWithGravity(Ljava/util/List;I)V
    ...
    iget v2, v1, Landroidx/appcompat/widget/Z0;->b:I
    ...
    iget v4, v2, Landroidx/appcompat/widget/Z0;->b:I
...
.method private addSystemView(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/Toolbar;->generateDefaultLayoutParams()Landroidx/appcompat/widget/Z0;
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/Toolbar;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/Z0;
...
.method private ensureContentInsets()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Landroidx/appcompat/widget/q0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mContentInsets:Landroidx/appcompat/widget/q0;
...
.method private ensureMenu()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActionMenuView;->peekMenu()Landroidx/appcompat/view/menu/r;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/view/menu/r;->c(Landroidx/appcompat/view/menu/F;Landroid/content/Context;)V
...
.method private ensureMenuView()V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->mMenuBuilderCallback:Landroidx/appcompat/view/menu/p;

    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/widget/ActionMenuView;->setMenuCallbacks(Landroidx/appcompat/view/menu/E;Landroidx/appcompat/view/menu/p;)V
...
.method private getViewListMeasuredWidth(Ljava/util/List;[I)I
    ...
    check-cast v6, Landroidx/appcompat/widget/Z0;
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    instance-of p1, p1, Landroidx/appcompat/widget/Z0;
...
.method public collapseActionView()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;
    ...
    :cond_0
    iget-object v0, v0, Landroidx/appcompat/widget/Y0;->b:Landroidx/appcompat/view/menu/u;
...
.method ensureCollapseButtonView()V
    ...
    invoke-direct {v1, p0}, Landroidx/appcompat/widget/X0;-><init>(Landroidx/appcompat/widget/Toolbar;)V
...
.method protected generateDefaultLayoutParams()Landroidx/appcompat/widget/Z0;
    .locals 1
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/Toolbar;->generateLayoutParams(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/Z0;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/Toolbar;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/Z0;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/Z0;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroidx/appcompat/widget/Z0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/Z0;
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroidx/appcompat/widget/Z0;-><init>(Landroidx/appcompat/widget/Z0;)V
    ...
    invoke-direct {v0, p1}, Landroidx/appcompat/widget/Z0;-><init>(Landroidx/appcompat/app/a;)V
    ...
    invoke-direct {v0, p1}, Landroidx/appcompat/widget/Z0;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroidx/appcompat/widget/Z0;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method getOuterActionMenuPresenter()Landroidx/appcompat/widget/p;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mOuterActionMenuPresenter:Landroidx/appcompat/widget/p;
...
.method public getWrapper()Landroidx/appcompat/widget/Y;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mWrapper:Landroidx/appcompat/widget/e1;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mWrapper:Landroidx/appcompat/widget/e1;
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v15, Landroidx/appcompat/widget/Z0;
    ...
    check-cast v3, Landroidx/appcompat/widget/Z0;
    ...
    check-cast v4, Landroidx/appcompat/widget/Z0;
...
.method protected onMeasure(II)V
    ...
    iget v0, v0, Landroidx/appcompat/widget/Z0;->b:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    :goto_0
    iget v1, p1, Landroidx/appcompat/widget/b1;->c:I

    if-eqz v1, :cond_2

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;

    if-eqz v2, :cond_2

    if-eqz v0, :cond_2

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/r;->findItem(I)Landroid/view/MenuItem;
    ...
    :cond_2
    iget-boolean p1, p1, Landroidx/appcompat/widget/b1;->d:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Landroidx/appcompat/widget/b1;-><init>(Landroid/os/Parcelable;)V

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;

    if-eqz v1, :cond_0

    iget-object v1, v1, Landroidx/appcompat/widget/Y0;->b:Landroidx/appcompat/view/menu/u;
    ...
    iput v1, v0, Landroidx/appcompat/widget/b1;->c:I
    ...
    iput-boolean v1, v0, Landroidx/appcompat/widget/b1;->d:Z
...
.method removeChildrenForExpandedActionView()V
    ...
    iget v2, v2, Landroidx/appcompat/widget/Z0;->b:I
...
.method public setMenu(Landroidx/appcompat/view/menu/r;Landroidx/appcompat/widget/p;)V
    .locals 3
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mOuterActionMenuPresenter:Landroidx/appcompat/widget/p;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/r;->z(Landroidx/appcompat/view/menu/F;)V
    ...
    invoke-direct {v0, p0}, Landroidx/appcompat/widget/Y0;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;

    :cond_3
    const/4 v0, 0x1

    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/p;->z(Z)V

    if-eqz p1, :cond_4

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mPopupContext:Landroid/content/Context;

    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/view/menu/r;->c(Landroidx/appcompat/view/menu/F;Landroid/content/Context;)V

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->mPopupContext:Landroid/content/Context;

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/view/menu/r;->c(Landroidx/appcompat/view/menu/F;Landroid/content/Context;)V
    ...
    invoke-virtual {p2, p1, v1}, Landroidx/appcompat/widget/p;->f(Landroid/content/Context;Landroidx/appcompat/view/menu/r;)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->mPopupContext:Landroid/content/Context;

    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/Y0;->f(Landroid/content/Context;Landroidx/appcompat/view/menu/r;)V

    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/p;->b(Z)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mExpandedMenuPresenter:Landroidx/appcompat/widget/Y0;

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/Y0;->b(Z)V
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/widget/ActionMenuView;->setPresenter(Landroidx/appcompat/widget/p;)V

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar;->mOuterActionMenuPresenter:Landroidx/appcompat/widget/p;

    return-void
.end method

.method public setMenuCallbacks(Landroidx/appcompat/view/menu/E;Landroidx/appcompat/view/menu/p;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mActionMenuPresenterCallback:Landroidx/appcompat/view/menu/E;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar;->mMenuBuilderCallback:Landroidx/appcompat/view/menu/p;

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->mMenuView:Landroidx/appcompat/widget/ActionMenuView;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/ActionMenuView;->setMenuCallbacks(Landroidx/appcompat/view/menu/E;Landroidx/appcompat/view/menu/p;)V
...
.method public setOnMenuItemClickListener(Landroidx/appcompat/widget/a1;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->mOnMenuItemClickListener:Landroidx/appcompat/widget/a1;
