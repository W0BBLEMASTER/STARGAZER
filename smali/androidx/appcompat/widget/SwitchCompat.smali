...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v2, p3, v1}, Landroidx/appcompat/widget/U0;->t(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/U0;

    move-result-object p2

    sget p3, Lb/j;->SwitchCompat_android_thumb:I

    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/U0;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p3, Lb/j;->SwitchCompat_track:I
    ...
    :cond_1
    sget p3, Lb/j;->SwitchCompat_android_textOn:I

    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/U0;->o(I)Ljava/lang/CharSequence;

    move-result-object p3

    iput-object p3, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextOn:Ljava/lang/CharSequence;

    sget p3, Lb/j;->SwitchCompat_android_textOff:I
    ...
    sget p3, Lb/j;->SwitchCompat_showText:I

    invoke-virtual {p2, p3, v3}, Landroidx/appcompat/widget/U0;->a(IZ)Z

    move-result p3

    iput-boolean p3, p0, Landroidx/appcompat/widget/SwitchCompat;->mShowText:Z

    sget p3, Lb/j;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {p2, p3, v1}, Landroidx/appcompat/widget/U0;->e(II)I

    move-result p3

    iput p3, p0, Landroidx/appcompat/widget/SwitchCompat;->mThumbTextPadding:I

    sget p3, Lb/j;->SwitchCompat_switchMinWidth:I
    ...
    sget p3, Lb/j;->SwitchCompat_switchPadding:I
    ...
    sget p3, Lb/j;->SwitchCompat_splitTrack:I

    invoke-virtual {p2, p3, v1}, Landroidx/appcompat/widget/U0;->a(IZ)Z

    move-result p3

    iput-boolean p3, p0, Landroidx/appcompat/widget/SwitchCompat;->mSplitTrack:Z

    sget p3, Lb/j;->SwitchCompat_thumbTint:I

    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/U0;->c(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget p3, Lb/j;->SwitchCompat_thumbTintMode:I

    const/4 v2, -0x1

    invoke-virtual {p2, p3, v2}, Landroidx/appcompat/widget/U0;->j(II)I

    move-result p3

    invoke-static {p3, v0}, Landroidx/appcompat/widget/Z;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget p3, Lb/j;->SwitchCompat_trackTint:I
    ...
    :cond_6
    sget p3, Lb/j;->SwitchCompat_trackTintMode:I
    ...
    :cond_9
    sget p3, Lb/j;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {p2, p3, v1}, Landroidx/appcompat/widget/U0;->m(II)I
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/Z;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Landroidx/appcompat/widget/Z;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Landroidx/appcompat/widget/Z;->a:Landroid/graphics/Rect;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Landroidx/appcompat/widget/Z;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/Z;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/U0;->j(II)I
    ...
    invoke-direct {p2, v0}, Le/a;-><init>(Landroid/content/Context;)V
