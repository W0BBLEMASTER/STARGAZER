...
.field mPopup:Landroidx/appcompat/widget/S;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-direct {v3, p1, p5}, Lf/e;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {v0, p5, v1}, Landroidx/appcompat/widget/U0;->m(II)I
    ...
    invoke-direct {v3, p1, p5}, Lf/e;-><init>(Landroid/content/Context;I)V
    ...
    new-instance p4, Landroidx/appcompat/widget/S;

    iget-object p5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    invoke-direct {p4, p0, p5, p2, p3}, Landroidx/appcompat/widget/S;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object p5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    sget-object v4, Lb/j;->Spinner:[I

    invoke-static {p5, p2, v4, p3, v1}, Landroidx/appcompat/widget/U0;->t(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/U0;

    move-result-object p5

    sget v1, Lb/j;->Spinner_android_dropDownWidth:I

    const/4 v4, -0x2

    invoke-virtual {p5, v1, v4}, Landroidx/appcompat/widget/U0;->l(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mDropDownWidth:I

    sget v1, Lb/j;->Spinner_android_popupBackground:I

    invoke-virtual {p5, v1}, Landroidx/appcompat/widget/U0;->f(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iget-object v4, p4, Landroidx/appcompat/widget/n0;->y:Landroid/widget/PopupWindow;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/U0;->n(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroidx/appcompat/widget/S;->y(Ljava/lang/CharSequence;)V

    invoke-virtual {p5}, Landroidx/appcompat/widget/U0;->u()V

    iput-object p4, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/S;

    new-instance p5, Landroidx/appcompat/widget/M;

    invoke-direct {p5, p0, p0, p4}, Landroidx/appcompat/widget/M;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/view/View;Landroidx/appcompat/widget/S;)V

    iput-object p5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:Landroidx/appcompat/widget/f0;

    :cond_5
    sget p4, Lb/j;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroidx/appcompat/widget/U0;->p(I)[Ljava/lang/CharSequence;
    ...
    :cond_6
    invoke-virtual {v0}, Landroidx/appcompat/widget/U0;->u()V
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/S;
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/n0;->e()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/n0;->y:Landroid/widget/PopupWindow;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/S;->w()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/S;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:Landroidx/appcompat/widget/f0;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/S;
    ...
    invoke-direct {v2, p1, v0}, Landroidx/appcompat/widget/N;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/S;->h(Landroid/widget/ListAdapter;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/S;->y(Ljava/lang/CharSequence;)V
