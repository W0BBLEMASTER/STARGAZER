...
.field private final mLeftCallback:Landroidx/drawerlayout/widget/h;

.field private final mLeftDragger:LA/d;
...
.field private final mRightCallback:Landroidx/drawerlayout/widget/h;

.field private final mRightDragger:LA/d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance p2, Landroidx/drawerlayout/widget/c;

    invoke-direct {p2}, Landroidx/drawerlayout/widget/c;-><init>()V

    iput-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mChildAccessibilityDelegate:Landroidx/drawerlayout/widget/c;
    ...
    new-instance v2, Landroidx/drawerlayout/widget/h;

    invoke-direct {v2, p0, p3}, Landroidx/drawerlayout/widget/h;-><init>(Landroidx/drawerlayout/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftCallback:Landroidx/drawerlayout/widget/h;

    new-instance p3, Landroidx/drawerlayout/widget/h;

    const/4 v3, 0x5

    invoke-direct {p3, p0, v3}, Landroidx/drawerlayout/widget/h;-><init>(Landroidx/drawerlayout/widget/DrawerLayout;I)V

    iput-object p3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightCallback:Landroidx/drawerlayout/widget/h;

    const/high16 v3, 0x3f800000    # 1.0f

    invoke-static {p0, v3, v2}, LA/d;->j(Landroid/view/ViewGroup;FLA/c;)LA/d;

    move-result-object v4

    iput-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;

    invoke-virtual {v4, p2}, LA/d;->y(I)V

    invoke-virtual {v4, v1}, LA/d;->z(F)V

    invoke-virtual {v2, v4}, Landroidx/drawerlayout/widget/h;->m(LA/d;)V

    invoke-static {p0, v3, p3}, LA/d;->j(Landroid/view/ViewGroup;FLA/c;)LA/d;

    move-result-object v2

    iput-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LA/d;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, LA/d;->y(I)V

    invoke-virtual {v2, v1}, LA/d;->z(F)V

    invoke-virtual {p3, v2}, Landroidx/drawerlayout/widget/h;->m(LA/d;)V
    ...
    invoke-static {p0, p2}, Lw/t;->e(Landroid/view/View;Lw/b;)V
    ...
    invoke-direct {p3}, Landroidx/drawerlayout/widget/a;-><init>()V
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, p2}, Lw/t;->e(Landroid/view/View;Lw/b;)V
...
.method public closeDrawer(Landroid/view/View;Z)V
    ...
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;
    ...
    :cond_1
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LA/d;
    ...
    invoke-virtual {p2, p1, v0, v1}, LA/d;->C(Landroid/view/View;II)Z
    ...
    iget p2, v0, Landroidx/drawerlayout/widget/e;->a:I
...
.method closeDrawers(Z)V
    ...
    iget-object v7, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;
    ...
    invoke-virtual {v7, v4, v6, v8}, LA/d;->C(Landroid/view/View;II)Z
    ...
    :cond_1
    iget-object v6, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LA/d;
    ...
    invoke-virtual {v6, v4, v7, v8}, LA/d;->C(Landroid/view/View;II)Z
    ...
    :cond_3
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftCallback:Landroidx/drawerlayout/widget/h;

    invoke-virtual {p1}, Landroidx/drawerlayout/widget/h;->l()V

    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightCallback:Landroidx/drawerlayout/widget/h;
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;

    invoke-virtual {v0}, LA/d;->i()Z

    move-result v0

    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LA/d;
...
.method dispatchOnDrawerClosed(Landroid/view/View;)V
    ...
    invoke-interface {v2}, Landroidx/drawerlayout/widget/d;->d()V
...
.method dispatchOnDrawerOpened(Landroid/view/View;)V
    ...
    invoke-interface {v1}, Landroidx/drawerlayout/widget/d;->a()V
...
.method dispatchOnDrawerSlide(Landroid/view/View;F)V
    ...
    invoke-interface {p2}, Landroidx/drawerlayout/widget/d;->c()V
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v8, v0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;

    invoke-virtual {v8}, LA/d;->n()I
    ...
    iget-object v10, v0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LA/d;

    invoke-virtual {v10}, LA/d;->n()I
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroidx/drawerlayout/widget/e;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Landroidx/drawerlayout/widget/e;-><init>(Landroidx/drawerlayout/widget/e;)V
    ...
    invoke-direct {v0, p1}, Landroidx/drawerlayout/widget/e;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroidx/drawerlayout/widget/e;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;

    invoke-virtual {v1, p1}, LA/d;->B(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LA/d;

    invoke-virtual {v2, p1}, LA/d;->B(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;

    invoke-virtual {p1}, LA/d;->e()Z
    ...
    iget-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, LA/d;->k(II)Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    check-cast v11, Landroidx/drawerlayout/widget/e;

    const/4 v12, 0x3

    if-eqz v1, :cond_c

    iget v13, v11, Landroidx/drawerlayout/widget/e;->a:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    :cond_2
    iget v0, p1, Landroidx/drawerlayout/widget/f;->e:I
    ...
    :cond_3
    iget v0, p1, Landroidx/drawerlayout/widget/f;->f:I
    ...
    :cond_4
    iget p1, p1, Landroidx/drawerlayout/widget/f;->g:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Landroidx/drawerlayout/widget/f;-><init>(Landroid/os/Parcelable;)V
    ...
    iput v0, v1, Landroidx/drawerlayout/widget/f;->f:I

    iget v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLockModeEnd:I

    iput v0, v1, Landroidx/drawerlayout/widget/f;->g:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, LA/d;->s(Landroid/view/MotionEvent;)V

    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LA/d;
    ...
    iget-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LA/d;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, LA/d;->k(II)Landroid/view/View;
...
.method public openDrawer(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, p1, v1, v0}, LA/d;->C(Landroid/view/View;II)Z
...
.method updateDrawerState(IILandroid/view/View;)V
    ...
    invoke-interface {p2}, Landroidx/drawerlayout/widget/d;->b()V
